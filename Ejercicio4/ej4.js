...
let nombre= window.prompt("Escribe un nombre")
...
<h1>El valor que queremos mostrar es ${randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board}`;


document.getElementById("resultado2").innerHTML=`
<h1>El valor que hemos añadido es ${randomObject.them.speed.past.program.grade.addition.whose.national.cannot.name}`;
